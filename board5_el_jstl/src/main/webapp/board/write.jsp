<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.ssafy.member.model.MemberDto"%>
<%
...
<html lang="ko">
  ...
  <body>
    <div class="container">
      <!-- 로그인 사용자 정보(로그아웃) 출력 -->
     <jsp:include page="/common/confirm.jsp"></jsp:include>
